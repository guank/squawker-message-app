...
public class SquawkFirebaseMessageService extends FirebaseMessagingService {
    ...
    private void sendNotification(Map<String, String> data){
        ...
        /* If message is longer than max number of characters, truncate it and add unicode
         * characters for ellipses in notification */
    ...
    private void insertSquawk(final Map<String, String> data){
        ...
        /* Database operation shouldn't be on main thread */
